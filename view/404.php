...
<body style="background-color: #212121;">
    <div class="container flex flex-column full-width align-items-center" style="padding: 0;">
        <div class="top-section flex flex-column full-width align-items-center">
            <div class="image-holder flex justify-content-center">
                ...
                <div class="corgi">
                    <img src="asset/img/corgi-lies-on-ground.svg" class="corgi--default" alt="Dog lies on the ground">
                    <img src="asset/img/corgi-lies-on-ground-looking-back.svg" class="corgi--hover" alt="Dog lies on the ground and looks back">
                </div>
