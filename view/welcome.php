                    ...
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left align-self-center">
                            ...
                            <p>
                                ...
                                <a rel="sponsored" class="text-success" href="shop" target="_blank"">mirar catalogo</a>.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="shop-single" class="h2 text-decoration-none text-dark">Cetirizina</a>
                        <p class="card-text">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="shop-single" class="h2 text-decoration-none text-dark">Vitamina E</a>
                        <p class="card-text">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="shop-single" class="h2 text-decoration-none text-dark">Losartán</a>
                        <p class="card-text">
